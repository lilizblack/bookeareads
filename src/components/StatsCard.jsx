...
const StatsCard = ({ label, count, colorClass, onClick }) => {
    return (
        <button
            onClick={onClick}
            className={`w-full rounded-2xl p-4 flex flex-col items-center justify-center ${colorClass} contrast-card transition-all active:scale-95 hover:brightness-95 cursor-pointer border-none outline-none`}
        >
